...
ffmpeg -y -hide_banner -loglevel error \
  -f lavfi -i "sine=frequency=110:sample_rate=44100:duration=160" \
  -f lavfi -i "sine=frequency=164.81:sample_rate=44100:duration=160" \
  -f lavfi -i "sine=frequency=220:sample_rate=44100:duration=160" \
  -f lavfi -i "sine=frequency=329.63:sample_rate=44100:duration=160" \
  -filter_complex "\
   ...
   afade=t=in:st=0:d=4,afade=t=out:st=156:d=4,volume=0.5[out]" \
